...
$(document).ready(function(e) 
    {
		...
		{
			//se crea la base de datos Test es el nombre de la bd, 1.0 la version y 65525 el tamaño en bytes
			...
			function error (transaction, err) {
				alert("Error de la Base de Datos :"+err.message);
				return false;
			}//Funcion error
			$("#Insertar").bind("click", function (event)
			{
				...
				{
					var sql= "INSERT INTO Clientes (nombre, apellido) VALUE (?, ?)";
				...
				db.transaction(function (ejecutar)
				{
					...
					ejecutar.executeSql (sql, undefined,function (ejecutar, resultado)
					{
						...
						$("#listado").unbind().bind ("pagebeforeshow", function ()
						{
							...
							//en lugar de viñetas msalga en forma de lista
							$ul.listview ();
						});//listado
